...
- computes $A^p$
- determiness minimum and maximum diagonal element
...
10$ sbatch  --export=ALL,SIZE=000,POWER=10  memory_and_walltime.slurm
$ sbatch  --export=ALL,SIZE=000,POWER=20  memory_and_walltime.slurm
$ sbatch  --export=ALL,SIZE=000,POWER=40  memory_and_walltime.slurm
...
```
...
```bash
$ sacct  --cluster=wice  --jobs=62199204.batch  --format=jobid,maxrss
```
:::
